...
class AdminController {
    ...
    static async createUser(req, res, next) {
        try {
            ...
            res.status(201).json({
                ...
                user: { id: userId, name, email, password: isAutoGenerated ? password : '****' },
    ...
    static async createHR(req, res, next) {
        try {
            ...
            res.status(201).json({
                ...
                data: { id: userId, name, email, password: isAutoGenerated ? password : '****' },
                email_sent: emailStatus.success,
                email_error: emailStatus.success ? null : emailStatus.error
            });
    ...
    static async updateUser(req, res, next) {
        try {
            const { userId } = req.params;
            const { 
                name, email, phone, cnic, address, status, 
                designation, department, manager_id, reporting_to, 
                shift_id, role_type, leave_quota 
            } = req.body;
            ...
            // Update Leave Quota if provided
    ...
    static async createAdmin(req, res, next) {
        try {
            ...
            res.status(201).json({
                ...
                admin: { id: adminId, name, email, role, password: isAutoGenerated ? password : '****' },
                email_sent: emailStatus.success,
                email_error: emailStatus.success ? null : emailStatus.error
            });

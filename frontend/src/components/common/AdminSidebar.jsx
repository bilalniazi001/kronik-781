...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navigation = [
    ...
    { name: 'GM Management', href: '/admin/gms', icon: UsersIcon },
    { name: 'ACM Management', href: '/admin/acms', icon: UsersIcon },
    { name: 'HR Management', href: '/admin/hr', icon: UsersIcon },
    { name: 'Team Lead (TL)', href: '/admin/team-leads', icon: UsersIcon },
    { name: 'ATL Management', href: '/admin/atls', icon: UsersIcon },
  ...
  if (isAdmin || isHR || isCEO || isGM || isACM || isTL || isATL) {
    navigation.push({ 
      name: (isAdmin || isHR) ? 'Leave Approvals' : 'Team Requests', 

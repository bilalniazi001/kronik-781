...
const adminService = {
  ...
  getGMs: (page, limit, search) => adminService.getUsers(page, limit, search, 'gm'),
  getACMs: (page, limit, search) => adminService.getUsers(page, limit, search, 'acm'),
  ...
  getATLs: (page, limit, search) => adminService.getUsers(page, limit, search, 'atl'),
